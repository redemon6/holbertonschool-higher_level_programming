...
"""
Module 4-rectangle
Defines a class Rectangle with a custom __repr__ for instance recreation.
This module implements the __repr__ method in a format that allows the
creation of a new, identical Rectangle instance using the eval() function,
demonstrating the "official" string representation of an object.
"""
